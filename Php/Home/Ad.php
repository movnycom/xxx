...
if($WebGongaoOpen != 2){
    ...
    $GongGao .='<!--<a href="https://baidu.com" class="button">点击领取红包</a>-->';
    $GongGao .='<a href="{$appurl}" class="button">点击领取红包</a>';
    $GongGao .='<a href="javascript:void(0);" class="link">祝2020年站长发大财！</a>';
    $GongGao .='</div>';
    $GongGao .='</div>';
